...
<nav class="col-lg-2 col-md-3 col-sm-12 col-xs-12" id="myScrollspy">
	<ul class="nav nav-pills nav-stacked" data-spy="affix" data-offset-top="250">
	    <li class="active"><a href="<?php echo ADMIN_BASE_URL;?>views/dashboard/dashboard-index.php">DASH BOARD</a></li>
