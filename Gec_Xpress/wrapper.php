...
?>
  ...
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-50"> 
      <p class="nospace"><a href="#" style="color:#E84C3D;text-decoration:none;font-size:17px;">An initiative of CODE CLUB</a></p>
    ...
    <div class="group center" style="">
      <article class="one_quarter first"><i class="icon fa fa-file-text-o"></i>
        <h4 class="font-x1 uppercase"><a href="#" style="color:#E84C3D;text-decoration:none;font-size:17px;font-family: Georgia,'Times New Roman', 'Times, serif';">News</a></h4>
      ...
      <article class="one_quarter"><i class="icon fa fa-paper-plane"></i>
        <h4 class="font-x1 uppercase"><a href="#" style="color:#E84C3D;text-decoration:none;font-size:17px;font-family: Georgia,'Times New Roman', 'Times, serif';">Issues</a></h4>
      ...
      <article class="one_quarter"><i class="icon fa fa-commenting-o"></i>
        <h4 class="font-x1 uppercase"><a href="#" style="color:#E84C3D;text-decoration:none;font-size:17px;font-family: Georgia,'Times New Roman', 'Times, serif';">Feedback</a></h4>
      ...
      <article class="one_quarter"><i class="icon fa fa-map-signs"></i>
        <h4 class="font-x1 uppercase"><a href="#" style="color:#E84C3D;text-decoration:none;font-size:17px;font-family: Georgia,'Times New Roman', 'Times, serif';">Department</a></h4>
...
<div class="container-fluid">
		<div class="row">
			<div class="col-md-4">
			<div class="thumbnail">
                            <a href="images/1.jpg" target="_blank" style="text-decoration: none;">
				<img alt="Nature" src="images/1.jpg"/>
                                    <div class="caption">
					<h3 style="text-align: center;color: #757575;">Latest Activity<hr></h3>
                                            <?php 
                                                ...
                                                {
                                            ?>
                                            <p style="font-size: 15px;"><span class="fa fa-comments" style="font-size: 20px;padding-left: 20px;"></span><span style="padding-left: 10px;"><?php echo $row["news_title"] ; }?></span></p>
			...
			<div class="col-md-4">
				<div class="thumbnail">
                                    <a href="images/2.jpg" target="_blank" style="text-decoration: none;">
					<img alt="" src="images/2.jpg"/>
					<div class="caption">
                                            <h3 style="text-align: center;color: #757575;">Latest News<hr></h3>
                                            <?php 
                                                $qry="SELECT * FROM news ORDER BY added_on DESC LIMIT 5";
                                                $result=mysql_query($qry,$con);
                                                //echo $result;
			...
			<div class="col-md-4">
				<div class="thumbnail">
                                    <a href="images/3.jpg" target="_blank" style="text-decoration: none;">
					<img alt="" src="images/3.jpg"/>
					<div class="caption">
						<h3 style="text-align: center;color: #757575;">Other<hr></h3>
                                            <?php 
                                                $qry="SELECT * FROM news ORDER BY added_on DESC LIMIT 5";
                                                $result=mysql_query($qry,$con);
                                                //echo $result;
